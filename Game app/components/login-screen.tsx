...
import { showNotification } from "@/utils/game-utils"
...
export default function LoginScreen({ teams, onJoinGame }: LoginScreenProps) {
  ...
  const handleTeamSelect = (teamId: number) => {
    ...
    if (teams[teamId].players >= 5) {
      showNotification(`${teams[teamId].name} is already full (5/5 players)`, "error")
      return
    }
  ...
  const handleJoinGame = () => {
    ...
    if (!selectedTeam) {
      showNotification("Please select your team", "error")
      return
    }
